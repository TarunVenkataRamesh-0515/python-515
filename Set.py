...
print("union",u) 
#union and update
 """ in update union of elements will be updated to set1 
and union method returns a new set
 """ 
set1.update(set2) 
print("update",set1) 
...
""" 
issubset()-->The issubset() method returns True if all elements of a set A are present in another set B which is passed as an argument and returns false if all elements not present.
